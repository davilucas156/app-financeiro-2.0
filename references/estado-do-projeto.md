...
| -------------------------------------------- | ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Storage dos CSVs em **Vercel Blob**          | ❌ não usado     | spec 02, C3: ao medir o que se perdia sem o arquivo, o que faltava eram as **linhas ignoradas**, não o CSV. Viraram `imports.ignoradas`, com motivo e conteúdo. A coluna `url_no_blob` foi **removida** em 30/08/2026 (migration 0012), nula nas 9 linhas que existiam. |
